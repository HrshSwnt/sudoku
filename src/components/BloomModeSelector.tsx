...
export default function BloomModeSelector() {
    ...
    return (
        <div className="flex gap-2 mb-2 mt-2 items-center">
            <label className="text-sm font-medium text-gray-700">Highlight Mode:</label>
            <select
                value={bloomMode}
                onChange={(e) => setBloomMode(e.target.value as BloomMode)}
                className="border-2 border-blue-400 rounded px-3 py-1.5 text-sm bg-blue-50 shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
            >
